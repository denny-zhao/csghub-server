...
func createMemoryRoutes(apiGroup *gin.RouterGroup, middlewareCollection middleware.MiddlewareCollection, memoryHandler *handler.MemoryHandler) {
	...
	{
		memoryGroup.GET("/models", memoryHandler.GetModels)
		memoryGroup.GET("/models/chat", memoryHandler.GetChatModel)
		memoryGroup.GET("/models/embedding", memoryHandler.GetEmbeddingModel)
		memoryGroup.POST("/models", memoryHandler.SetModels)
		memoryGroup.POST("/models/chat", memoryHandler.SetChatModel)
		memoryGroup.POST("/models/embedding", memoryHandler.SetEmbeddingModel)
		memoryGroup.DELETE("/models/chat", memoryHandler.DeleteChatModel)
		memoryGroup.DELETE("/models/embedding", memoryHandler.DeleteEmbeddingModel)
